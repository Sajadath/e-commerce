  ...
  return (
    <>
      <div className="mt-16 flex flex-col items-center justify-between gap-8 text-left md:flex-row">
        <div className="">© 2025 VastShopper</div>
      ...
      <div dir="ltr" className="grid w-full grid-cols-[1fr_auto_1fr] pt-6">
        ...
        <div className="text-center text-xs text-gray-600">
          All Rights Are Reserved <br /> © 2025 VastShopper By SajadAth
        </div>
